...
def load_data(dataset_name):
    ...
    return adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, labels, idx_train, idx_val, idx_test, AF_
...
if __name__ == '__main__':
    ...
    adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, labels, idx_train, idx_val, idx_test, AF_ = load_data(
        'cora')
